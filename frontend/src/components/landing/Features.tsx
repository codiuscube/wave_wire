...
export function Features() {
  return (
    <section
      id="features"
      className="relative pt-64 pb-32 lg:py-32 bg-brand-abyss overflow-hidden"
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="mb-20 border-l-4 border-brand-rogue pl-6">
          <h2 className="text-4xl sm:text-6xl md:text-7xl font-display font-black tracking-tighter text-white mb-4 uppercase leading-[0.8] break-words">
            PURE SIGNAL.<br />
            <span className="bg-clip-text bg-gradient-to-r from-brand-acid to-white text-brand-concrete">ZERO NOISE.</span>
          </h2>
